...
ALTER TABLE `questions_question`
    ...
    ADD CONSTRAINT `product_id_refs_id_9659be74` FOREIGN KEY (`locale_id`) REFERENCES `products_product` (`id`),

    ADD COLUMN `topic_id` integer NULL,
    ADD CONSTRAINT `topic_id_refs_id_b4f2f293` FOREIGN KEY (`locale_id`) REFERENCES `topics_topic` (`id`);
