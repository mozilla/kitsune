...
./scripts/peep install -r requirements/compiled.txt > /dev/null
./scripts/peep install -r requirements/requirements_src.txt > /dev/null
./scripts/peep install -r requirements/requirements_packages.txt > /dev/null
