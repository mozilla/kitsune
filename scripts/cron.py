...
@babis.decorator(ping_after=settings.DMS_HANDLE_DUE_TASKS_FOR_TRANSLATIONS)
def job_handle_due_tasks_for_translations():
    call_command("handle_due_tasks_for_translations")
