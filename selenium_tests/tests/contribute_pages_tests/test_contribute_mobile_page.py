...
class TestContributeMobilePage(TestUtilities):
    ...
    def test_contribute_mobile_page_text(self):
        self.logger.info(
            "Accessing the Contribute Mobile page"
        )
        self.pages.ways_to_contribute_pages.navigate_to(ContributeMobileStoreSupportMessages.STAGE_CONTRIBUTE_MOBILE_SUPPORT_PAGE_URL)

        self.logger.info(
            "Verifying that the Contribute Mobile  page contains the correct strings"
        )
        ...
        card_titles = [ContributeMobileStoreSupportMessages.HOW_TO_CONTRIBUTE_OPTION_ONE_SIGNED_OUT,
        ...
        other_ways_to_contribute_card_titles = [ContributeMobileStoreSupportMessages.ANSWER_QUESTIONS_IN_SUPPORT_FORUM_TITLE_CARD_TITLE,
    ...
    def test_contribute_mobile_page_images_are_not_broken(self):
        ...
        self.logger.info(
            "Verifying that the Contribute Mobile page images are not broken"
        )
    ...
    def test_contribute_mobile_page_breadcrumbs(self):
        ...
        breadcrumbs = [ContributeMobileStoreSupportMessages.FIRST_BREADCRUMB,
