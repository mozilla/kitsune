...
class TestContributePage(TestUtilities):
    ...
    def test_contribute_page_text(self):
        self.logger.info(
            "Clicking on the Contribute top-navbar option"
        )
        self.pages.top_navbar.click_on_contribute_top_navbar_option()

        self.logger.info(
            "Verify that the contribute page contains the correct strings"
        )
        ...
        card_titles = [ContributePageMessages.ANSWER_QUESTIONS_CARD_TITLE,
    ...
    def test_contribute_page_images_are_not_broken(self):
        ...
        self.logger.info(
            "Verifying that the Contribute page images are not broken"
        )
    ...
    def test_contribute_page_breadcrumbs(self):
        ...
        breadcrumbs = [ContributePageMessages.FIRST_BREADCRUMB, ContributePageMessages.SECOND_BREADCRUMB]
