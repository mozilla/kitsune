...
class TestContributeLocalizationPage(TestUtilities):
    ...
    def test_contribute_localization_page_text(self):
        self.logger.info(
            "Accessing the Contribute Localization page"
        )
        self.pages.ways_to_contribute_pages.navigate_to(ContributeLocalizationMessages.STAGE_CONTRIBUTE_LOCALIZATION_PAGE_URL)
        ...
        card_titles = [ContributeLocalizationMessages.HOW_TO_CONTRIBUTE_OPTION_ONE_SIGNED_OUT,
        ...
        check.equal(
            ...
            f"Expected is: {ContributeLocalizationMessages.HOW_TO_CONTRIBUTE_OPTION_FOUR}"
        )
        ...
        check.equal(
            ...
            f"Expected is: {ContributeLocalizationMessages.OTHER_WAYS_TO_CONTRIBUTE_HEADER}"
        )

        other_ways_to_contribute_card_titles = [ContributeLocalizationMessages.ANSWER_QUESTIONS_IN_SUPPORT_FORUM_TITLE,
    ...
    def test_contribute_localization_page_images_are_not_broken(self):
        ...
        self.logger.info(
            "Verifying that the Contribute Localization page images are not broken"
        )
    ...
    def test_contribute_localization_page_breadcrumbs(self):
        ...
        breadcrumbs = [ContributeLocalizationMessages.FIRST_BREADCRUMB,
    ...
    def test_contribute_localization_other_ways_to_contribute_redirect_to_the_correct_page(self):
        ...
        ways_to_contribute_links = [ContributeForumMessages.STAGE_CONTRIBUTE_FORUM_PAGE_URL,
