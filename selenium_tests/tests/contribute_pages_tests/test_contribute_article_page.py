...
class TestContributeArticlePage(TestUtilities):
    ...
    def test_contribute_article_page_text(self):
        ...
        card_titles = [ContributeHelpArticlesMessages.HOW_TO_CONTRIBUTE_OPTION_ONE_SIGNED_OUT,
        ...
        other_ways_to_contribute_card_titles = [ContributeHelpArticlesMessages.ANSWER_QUESTIONS_IN_SUPPORT_FORUM_TITLE,
    ...
    def test_contribute_article_page_images_are_not_broken(self):
        ...
        self.logger.info(
            "Verifying that the Contribute Article page images are not broken"
        )
    ...
    def test_contribute_article_page_breadcrumbs(self):
        ...
        breadcrumbs = [ContributeHelpArticlesMessages.FIRST_BREADCRUMB,
