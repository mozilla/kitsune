...
from selenium_tests.messages.contribute_pages_messages.contribute_forum_page_messages import ContributeForumMessages
from selenium_tests.messages.contribute_pages_messages.contribute_help_articles_page_messages import ContributeHelpArticlesMessages
from selenium_tests.messages.contribute_pages_messages.contribute_localization_page_messages import ContributeLocalizationMessages
from selenium_tests.messages.contribute_pages_messages.contribute_mobile_store_support_page_messages import ContributeMobileStoreSupportMessages
from selenium_tests.messages.contribute_pages_messages.contribute_page_messages import ContributePageMessages
from selenium_tests.messages.contribute_pages_messages.contribute_social_support_messages import ContributeSocialSupportMessages
...
class TestContributeForumPage(TestUtilities):
    ...
    def test_contribute_forum_page_text(self):
        self.logger.info(
            "Accessing the Contribute Forum page"
        )
        self.pages.ways_to_contribute_pages.navigate_to(ContributeForumMessages.STAGE_CONTRIBUTE_FORUM_PAGE_URL)

        self.logger.info(
            "Verifying that the Contribute Forum page contains the correct strings"
        )
        ...
        card_titles = [ContributeForumMessages.HOW_TO_CONTRIBUTE_OPTION_ONE_SIGNED_OUT,
        ...
        check.equal(
            ...
            f"Expected is: {ContributeForumMessages.HOW_TO_CONTRIBUTE_OPTION_FOUR}"
        )
        ...
        check.equal(
            ...
            f"Expected is: {ContributeForumMessages.OTHER_WAYS_TO_CONTRIBUTE_HEADER}"
        )

        other_ways_to_contribute_card_titles = [ContributeForumMessages.WRITE_ARTICLES_CARD_TITLE,
    ...
    def test_contribute_forum_page_images_are_not_broken(self):
        ...
        self.logger.info(
            "Verifying that the Contribute forum page images are not broken"
        )
        ...
        for link in self.pages.ways_to_contribute_pages.get_all_page_image_links():
            ...
            check.is_true(
                ...
                f"The {image_link} image is broken"
            )
    ...
    def test_contribute_forum_page_breadcrumbs(self):
        ...
        self.logger.info(
            "Verifying that the correct breadcrumbs are displayed"
        )
        breadcrumbs = [ContributeForumMessages.FIRST_BREADCRUMB,
        ...
        for breadcrumb in self.pages.ways_to_contribute_pages.get_all_interactable_breadcrumbs():
            breadcrumb_to_click = self.pages.ways_to_contribute_pages.get_all_interactable_breadcrumbs()[counter]
            ...
            if counter == 1:
                ...
                self.logger.info(
                    "Verifying that the Home breadcrumb redirects to the Homepage"
                )
                check.equal(
    ...
    def test_contribute_forum_other_ways_to_contribute_redirect_to_the_correct_page(self):
        ...
        ways_to_contribute_links = [ContributeHelpArticlesMessages.STAGE_CONTRIBUTE_HELP_ARTICLES_PAGE_URL,
        ...
        counter = 0
        for element in self.pages.ways_to_contribute_pages.get_all_other_ways_to_contribute_card_list():
            card = self.pages.ways_to_contribute_pages.get_all_other_ways_to_contribute_card_list()[counter]
