...
class TestContributeSocialMediaPage(TestUtilities):
    ...
    def test_contribute_social_page_text(self):
        ...
        card_titles = [ContributeSocialSupportMessages.HOW_TO_CONTRIBUTE_OPTION_ONE_SIGNED_OUT,
        ...
        other_ways_to_contribute_card_titles = [ContributeSocialSupportMessages.ANSWER_QUESTIONS_IN_SUPPORT_FORUM_TITLE,
    ...
    def test_contribute_social_page_images_are_not_broken(self):
        ...
        self.logger.info(
            "Verifying that the Contribute Social page images are not broken"
        )
    ...
    def test_contribute_social_page_breadcrumbs(self):
        ...
        breadcrumbs = [ContributeSocialSupportMessages.FIRST_BREADCRUMB,
