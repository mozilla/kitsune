    ...
    def test_product_cards_are_functional_and_redirect_to_proper_support_page(self):
        ...
        for element in self.pages.homepage.get_list_of_product_cards():
            ...
            check.equal(
                ...
                support_page_title,
                f"Incorrect support page title: "
                f"{support_page_title} "
                f"for clicked card with title: "
                f"{card_titles[counter]}!",
            )
            self.pages.homepage.wait_for_url_title_to_contain(card_titles[counter])
