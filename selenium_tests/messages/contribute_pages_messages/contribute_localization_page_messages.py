class ContributeLocalizationMessages:
    ...
    HERO_TEXT = "Help articles are not available in your language yet? You want to join the amazing team translating " \
    ...
    HOW_TO_CONTRIBUTE_OPTION_THREE = "Check if your locale is available and go to your localization dashboard"
