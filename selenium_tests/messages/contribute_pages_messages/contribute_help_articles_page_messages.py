class ContributeHelpArticlesMessages:
    ...
    HERO_TEXT = "If you like writing and teaching, then the Knowledge Base (KB) is the place for you. We need " \
    ...
    FACT_SECOND_LINE = "One article can be viewed by 400 million users and translated into 70+ languages"
