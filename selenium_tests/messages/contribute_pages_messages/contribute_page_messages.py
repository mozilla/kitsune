class ContributePageMessages:
    ...
    HERO_HELP_MILLION_OF_USERS_TEXT = "Help millions of users get the most out of their favorite browser. Your " \
                                      "contributions will reach millions of users worldwide, and you can do it from " \
                                      "the " \
                                      "comfort of your couch!"
    HERO_NEED_YOUR_HELP_TITLE = "We need your help!"
    HERO_NEED_YOUR_HELP_PARAGRAPH = "Used by more than 400 million people, Mozilla support is fully powered by " \
                                    "volunteers, " \
                                    "and it’s more important than ever. This is where you come in."
    ...
    ABOUT_US_CONTENT = "Mozilla Support is a community of enthusiastic volunteers and employees trying to support our " \
