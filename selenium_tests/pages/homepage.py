...
class Homepage(BasePage):
    ...
    __search_bar_button = (By.XPATH, "//form[@id='support-search-masthead']/button[@class='search-button']")
    ...
    __join_our_community_card_title = (By.XPATH, "//div[@class='card--callout-wrap-narrow']//h3[@class='card--title']")
    __join_our_community_card_description = (By.XPATH, "//div[@class='card--callout-wrap-narrow']//p[1]")
