...
class TestWikiParser(TestCase):
    ...
    def test_get_wiki_link_create(self):
        ...
        eq_(settings.WIKI_CREATE_URL % 'Inexistent+Page',
            self.p._getWikiLink('Inexistent Page'))
...
class TestWikiImageTags(TestCase):
    ...
    def test_page_link_caption(self):
        ...
        img_div = pq_img(
            self.p, '[[Image:file.png|page=Article List|my caption]]')
        img_a = img_div('a')
        img = img_a('img')
        caption = img_div.text()
    ...
    def test_link_caption(self):
        ...
        img_div = pq_img(
            self.p, '[[Image:file.png|link=http://example.com|caption]]')
        img_a = img_div('a')
        img = img_div('img')
        caption = img_div.text()
    ...
    def test_link_align(self):
        """Link with align."""
        img_div = pq_img(
            self.p, '[[Image:file.png|link=http://site.com|align=left]]')
        eq_('img align-left', img_div.attr('class'))

    def test_link_align_invalid(self):
        """Link with invalid align."""
        img_div = pq_img(
            self.p, '[[Image:file.png|link=http://example.ro|align=inv]]')
