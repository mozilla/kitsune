class ContributeHelpArticlesMessages:
    ...
    HERO_TEXT = (
        "If you like writing and teaching, then the Knowledge Base (KB) "
        "is the place for you. We need "
        "contributors that can write, edit or proofread articles in English. "
