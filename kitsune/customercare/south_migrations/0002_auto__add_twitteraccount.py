...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'customercare_twitteraccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('banned', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
        ))
        db.send_create_signal(u'customercare', ['TwitterAccount'])


    def backwards(self, orm):
        # Deleting model 'TwitterAccount'
        db.delete_table(u'customercare_twitteraccount')
