...
from kitsune.ai.questions.classify import classify
...
class ClassifyQuestionsTests(TestCase):
    ...
    def test_topic_1(self):
        ...
        self.assertIn(question.topic, [self.tabs])
    ...
    def test_topic_2(self):
        ...
        self.assertTrue(
            (question.topic == self.sync_data) or (question.topic.parent == self.sync_data)
        )
