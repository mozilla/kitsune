...
def search(request):
    ...
    index_group_data = [
        [group, read_index(group), write_index(group)] for group in index_groups
    ]
...
admin.site.register_view(
    path="search-maintenance", view=search, name="Search - Index Maintenance"
)
...
admin.site.register_view(
    path="search-index", view=index_view, name="Search - Index Browsing"
)
...
admin.site.register_view(
    path="synonym_bulk", view=synonym_editor, name="Search - Synonym Editor"
)
