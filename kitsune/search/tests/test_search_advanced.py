...
class AdvancedSearchTests(ElasticTestCase):
    ...
    def test_json_empty_query_a_1(self):
        ...
        response = self.client.get(
            reverse("search"), {"format": "json", "a": 1,}, follow=True
        )
        eq_(response.status_code, 200)
        eq_(response["Content-Type"], "application/json")
    ...
    def test_json_empty_query_a_2(self):
        ...
        response = self.client.get(
            reverse("search"), {"format": "json", "a": 2,}, follow=True
        )
    ...
    def test_search_products(self):
        ...
        doc = DocumentFactory(
            title=u"cookies", locale="en-US", category=10, products=[p]
        )
    ...
    def test_search_multiple_products(self):
        ...
        doc1 = DocumentFactory(
            title=u"cookies", locale="en-US", category=10, products=[p1, p2]
        )
