...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Remove Twitter.com link and keep Username only"""
        for profile in orm.Profile.objects.exclude(twitter=None):
            profile.twitter = profile.twitter.replace("https://www.twitter.com/","")
            profile.twitter = profile.twitter.replace("https://twitter.com/","")
            profile.twitter = profile.twitter.replace("http://www.twitter.com/","")
            profile.twitter = profile.twitter.replace("http://twitter.com/","")
            profile.twitter = profile.twitter.replace("#!/","")
            profile.twitter = profile.twitter.replace("@","")
            profile.twitter = profile.twitter.split('/')[0]
            profile.twitter = profile.twitter[0:15]
            profile.save()
