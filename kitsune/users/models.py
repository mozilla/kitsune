...
class Profile(ModelBase, SearchMixin):
    ...
    avatar = models.ImageField(upload_to=django_settings.USER_AVATAR_PATH, null=True,
                               blank=True, verbose_name=_lazy(u'Avatar'),
                               max_length=django_settings.MAX_FILEPATH_LENGTH)
    ...
    locale = LocaleField(default=django_settings.LANGUAGE_CODE,
    ...
    fxa_uid = models.CharField(
        blank=True, null=True, unique=True, max_length=128)
