...
class TestUserSerializer(TestCase):
    ...
    def test_cant_update_username(self):
        ...
        eq_(serializer.errors, {"username": [u"Can't change this field."],})
    ...
    def test_username_bad_chars(self):
        ...
        eq_(
            serializer.errors,
            {"username": [u'Usernames may only be letters, numbers, "." and "-".']},
        )
...
class TestUserView(TestCase):
    ...
    def test_create_user(self):
        ...
        res = self.client.post(
            url,
            {"username": username, "password": "testpass", "email": "kris@example.com"},
        )
