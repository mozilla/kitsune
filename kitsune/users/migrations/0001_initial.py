...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_profile', (
            ...
            ('mozillians', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
            ('irc_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('timezone', self.gf('timezones.fields.TimeZoneField')(null=True, blank=True)),
        ...
        db.create_table('users_setting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='settings', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
        ))
        db.send_create_signal('users', ['Setting'])

        # Adding unique constraint on 'Setting', fields ['user', 'name']
        db.create_unique('users_setting', ['user_id', 'name'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('users_setting', ['user_id', 'name'])

        # Deleting model 'Profile'
        db.delete_table('users_profile')

        # Deleting model 'Setting'
        db.delete_table('users_setting')
