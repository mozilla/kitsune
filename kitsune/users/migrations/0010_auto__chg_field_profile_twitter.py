...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_profile', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.twitter'
        db.alter_column(u'users_profile', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
