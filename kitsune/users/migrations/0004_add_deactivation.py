...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Deactivation'
        db.create_table('users_deactivation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('moderator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='deactivations', to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('users', ['Deactivation'])


    def backwards(self, orm):
        # Deleting model 'Deactivation'
        db.delete_table('users_deactivation')
    ...
    models = {
        ...
        'users.deactivation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deactivations'", 'to': "orm['auth.User']"}),
