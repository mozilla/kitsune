...
class TopUnhelpfulArticlesTests(TestCase):
    ...
    def test_current_articles(self):
        ...
        self.assertAlmostEqual(
            0.4 - old_data[r.document.id]["percentage"],
...
class L10nMetricsTests(TestCase):
    def test_update_l10n_coverage_metrics(self):
        ...
        eq_(
            5.0,
            WikiMetric.objects.get(locale="es", product=p, code=L10N_TOP20_CODE).value,
        )
        eq_(
            5.0,
            WikiMetric.objects.get(locale="es", product=p, code=L10N_TOP100_CODE).value,
        )
        eq_(
            5.0,
            WikiMetric.objects.get(locale="es", product=p, code=L10N_ALL_CODE).value,
        )
        eq_(
            5.0,
            WikiMetric.objects.get(
                locale="es", product=None, code=L10N_TOP20_CODE
            ).value,
        )
        eq_(
            5.0,
            WikiMetric.objects.get(
                locale="es", product=None, code=L10N_TOP100_CODE
            ).value,
        )
        eq_(
            5.0,
            WikiMetric.objects.get(locale="es", product=None, code=L10N_ALL_CODE).value,
        )
        ...
        eq_(
            10.0,
            WikiMetric.objects.get(locale="de", product=p, code=L10N_TOP20_CODE).value,
        )
        eq_(
            10.0,
            WikiMetric.objects.get(
                locale="de", product=None, code=L10N_TOP100_CODE
            ).value,
        )
        eq_(
            10.0,
            WikiMetric.objects.get(locale="de", product=p, code=L10N_ALL_CODE).value,
        )
        eq_(
            10.0,
            WikiMetric.objects.get(
                locale="de", product=None, code=L10N_TOP20_CODE
            ).value,
        )
        eq_(
            10.0,
        ...
        eq_(
            10.0,
            WikiMetric.objects.get(locale="de", product=None, code=L10N_ALL_CODE).value,
        )
        ...
        eq_(
            100.0,
            WikiMetric.objects.get(locale="ru", product=p, code=L10N_TOP20_CODE).value,
        )
        eq_(
            100.0,
            WikiMetric.objects.get(
                locale="ru", product=None, code=L10N_TOP100_CODE
            ).value,
        )
        eq_(
            100.0,
            WikiMetric.objects.get(locale="ru", product=p, code=L10N_ALL_CODE).value,
        )
        eq_(
            100.0,
            WikiMetric.objects.get(
                locale="ru", product=None, code=L10N_TOP20_CODE
            ).value,
        )
        eq_(
            100.0,
        ...
        eq_(
            100.0,
            WikiMetric.objects.get(locale="ru", product=None, code=L10N_ALL_CODE).value,
        )
        ...
        eq_(
            0.0,
            WikiMetric.objects.get(locale="it", product=p, code=L10N_TOP20_CODE).value,
        )
        eq_(
            0.0,
            WikiMetric.objects.get(
                locale="it", product=None, code=L10N_TOP100_CODE
            ).value,
        )
        eq_(
            0.0,
            WikiMetric.objects.get(locale="it", product=p, code=L10N_ALL_CODE).value,
        )
        eq_(
            0.0,
            WikiMetric.objects.get(
                locale="it", product=None, code=L10N_TOP20_CODE
            ).value,
        )
        eq_(
            0.0,
        ...
        eq_(
            0.0,
            WikiMetric.objects.get(locale="it", product=None, code=L10N_ALL_CODE).value,
        )
    ...
    def test_update_active_contributor_metrics(self):
        ...
        RevisionFactory(document=d, created=last_month, is_approved=True, reviewer=u)
        RevisionFactory(
            document=d, creator=u, created=last_month, reviewer=UserFactory()
        )
        ...
        eq_(
            3.0,
            WikiMetric.objects.get(locale="en-US", product=None, date=start_date).value,
        )
        eq_(
            1.0,
            WikiMetric.objects.get(locale="en-US", product=p, date=start_date).value,
        )
        eq_(
            4.0,
            WikiMetric.objects.get(locale="es", product=None, date=start_date).value,
        )
