...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.WikiMetric.objects.filter(locale='no').delete()
        orm.WikiMetric.objects.filter(locale='nb-NO').update(locale='no')

    def backwards(self, orm):
        """"Moves 'no' instances to 'nb-NO'."""
        orm.WikiMetric.objects.filter(locale='no').update(locale='nb-NO')
