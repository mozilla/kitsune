...
urlpatterns = [
    ...
    url(r"^api/v1/kpi/visitors/?$", api.VisitorsMetricList.as_view(), name="api.kpi.visitors"),
    url(
        r"^api/v1/kpi/contributors/?$",
        api.ContributorsMetricList.as_view(),
        name="api.kpi.contributors",
    ),
    url(r"^api/v1/kpi/kb-votes/?$", api.KBVoteMetricList.as_view(), name="api.kpi.kb-votes"),
    url(r"^api/v1/kpi/votes/?$", api.VoteMetricList.as_view(), name="api.kpi.votes"),
    url(r"^api/v1/kpi/questions/?$", api.QuestionsMetricList.as_view(), name="api.kpi.questions"),
    url(
