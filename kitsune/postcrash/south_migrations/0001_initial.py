...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('postcrash_signature', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('signature', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.Document'])),
        ))
        db.send_create_signal('postcrash', ['Signature'])


    def backwards(self, orm):
        # Deleting model 'Signature'
        db.delete_table('postcrash_signature')
    ...
    models = {
        ...
        'postcrash.signature': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'signature': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        },
        'products.product': {
