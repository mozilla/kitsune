...
def send_welcome_emails(logger: BasicLoggerProtocol = log) -> None:
    """
    ...
    logger.info(f"Sending {num_first_answer_messages} welcome emails for forum replies")
    logger.info(f"Sending {num_first_l10n_messages} welcome emails for localization")
