    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=models.CASCADE, related_name='answers', to=settings.AUTH_USER_MODEL)),
                ('marked_as_spam_by', models.ForeignKey(on_delete=models.CASCADE, related_name='answers_marked_as_spam', to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ['created'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.ForeignKey(on_delete=models.CASCADE, related_name='votes', to='questions.Answer')),
                ('creator', models.ForeignKey(on_delete=models.CASCADE, related_name='answer_votes', to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=models.CASCADE, related_name='questions', to=settings.AUTH_USER_MODEL)),
                ('last_answer', models.ForeignKey(on_delete=models.CASCADE, related_name='last_reply_in', blank=True, to='questions.Answer', null=True)),
                ('marked_as_spam_by', models.ForeignKey(on_delete=models.CASCADE, related_name='questions_marked_as_spam', to=settings.AUTH_USER_MODEL, null=True)),
                ('product', models.ForeignKey(on_delete=models.CASCADE, related_name='questions', default=None, to='products.Product', null=True)),
                ('solution', models.ForeignKey(on_delete=models.CASCADE, related_name='solution_for', to='questions.Answer', null=True)),
                ...
                ('taken_by', models.ForeignKey(on_delete=models.CASCADE, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('topic', models.ForeignKey(on_delete=models.CASCADE, related_name='questions', to='products.Topic', null=True)),
                ('updated_by', models.ForeignKey(on_delete=models.CASCADE, related_name='questions_updated', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ['-updated'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=models.CASCADE, related_name='metadata_set', to='questions.Question')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=models.CASCADE, to='questions.Question', unique=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime.now, db_index=True)),
                ('anonymous_id', models.CharField(max_length=40, db_index=True)),
                ('creator', models.ForeignKey(on_delete=models.CASCADE, related_name='question_votes', to=settings.AUTH_USER_MODEL, null=True)),
                ('question', models.ForeignKey(on_delete=models.CASCADE, related_name='votes', to='questions.Question')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='answers', to='questions.Question'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='answer',
            name='updated_by',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='answers_updated', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
    ]
