...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionLocale'
        db.create_table(u'questions_questionlocale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('locale', self.gf('kitsune.sumo.models.LocaleField')(default='en-US', max_length=7, unique=True)),
        ))
        db.send_create_signal(u'questions', ['QuestionLocale'])


    def backwards(self, orm):
        # Deleting model 'QuestionLocale'
        db.delete_table(u'questions_questionlocale')
