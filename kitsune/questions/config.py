...
products = OrderedDict([
    ('desktop', {
        ...
        'categories': OrderedDict([
            ...
            ('fix-problems', {
                'name': _lazy('Fix slowness, crashing, error messages and '
                              'other problems'),
                'topic': 'fix-problems',
                'tags': ['fix-problems'],
            }),
    ...
    ('firefox-private-network', {
        ...
        'subtitle': _lazy('Firefox Private Network'),
        'extra_fields': [],
        'tags': [],
    ...
    ('other', {
        'name': _lazy('Other Mozilla products'),
        'subtitle': '',
        'product': '',
        'html': _lazy('This site only provides support for some of our products. '
                      ...
                      '<li><a '
                      'href="/questions/new/thunderbird">'
                      'Lightning support</a></li>'
                      '</ul>'),
        'categories': OrderedDict([]),
        'deadend': True,
    }),
