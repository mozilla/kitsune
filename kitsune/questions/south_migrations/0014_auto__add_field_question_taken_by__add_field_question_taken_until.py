...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.taken_by'
        db.add_column(u'questions_question', 'taken_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.taken_until'
        db.add_column(u'questions_question', 'taken_until',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.taken_by'
        db.delete_column(u'questions_question', 'taken_by_id')

        # Deleting field 'Question.taken_until'
        db.delete_column(u'questions_question', 'taken_until')
    ...
    models = {
        ...
        u'questions.question': {
            ...
            'taken_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'taken_until': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'questions.questionlocale': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locale': ('kitsune.sumo.models.LocaleField', [], {'default': "'en-US'", 'unique': 'True', 'max_length': '7'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'questions_locales'", 'symmetrical': 'False', 'to': u"orm['products.Product']"})
        },
