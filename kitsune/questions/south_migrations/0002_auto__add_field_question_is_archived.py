...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.is_archived'

        db.add_column('questions_question', 'is_archived',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.is_archived'
        db.delete_column('questions_question', 'is_archived')
