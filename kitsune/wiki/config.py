...
COLLAPSIBLE_DOCUMENTS = {
    ...
    u"it": [u"firefox-connessioni-non-richieste",],
    u"pt-BR": [u"como-fazer-o-firefox-parar-de-se-conectar-automati",],
}
FALLBACK_LOCALES = {
    "ca": ["es"],  # Bug 800880
    "eu": ["es"],  # Bug 800880
...
SIGNIFICANCES = [
    (TYPO_SIGNIFICANCE, _lazy(u"Minor details that don't affect the instructions")),
    (
        MEDIUM_SIGNIFICANCE,
    ...
    (
        MAJOR_SIGNIFICANCE,
        _lazy(u"Major content changes that will make older translations " "inaccurate"),
    ),
]
...
DOC_HTML_CACHE_KEY = u"doc_html:{locale}:{slug}"
