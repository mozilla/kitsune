...
DESKTOP_FIREFOX_VERSIONS = (
    ...
    VersionMetadata(45, _lazy(u'Firefox 25'),
                    _lazy(u'Firefox 25'), 'fx25', 25.9999, True, True),
    VersionMetadata(43, _lazy(u'Firefox 24'),
                    _lazy(u'Firefox 24'), 'fx24', 24.9999, True, False),
    VersionMetadata(41, _lazy(u'Firefox 23'),
                    _lazy(u'Firefox 23'), 'fx23', 23.9999, True, False),
    ...
    VersionMetadata(35, _lazy(u'Firefox 20'),
                    _lazy(u'Firefox 20'), 'fx20', 20.9999, False, False),
    ...
    VersionMetadata(29, _lazy(u'Firefox ESR'),
                    _lazy(u'Firefox ESR'), 'fx17', 17.9999, True, False),
    ...
    VersionMetadata(15, _lazy(u'Firefox ESR'),
                    _lazy(u'Firefox ESR'), 'fx10', 10.9999, False, False),
