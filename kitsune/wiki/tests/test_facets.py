...
class TestFacetHelpers(TestCase):
    ...
    def test_topics_for_products(self):
        ...
        mobile_topics = topics_for(self.staff, product=self.mobile)
        self.assertEqual(
            set(t.slug for t in mobile_topics),
    ...
    def test_documents_for(self):
        ...
        with self.subTest("documents_for-general-user1"):
            ...
            self.assertEqual([d["id"] for d in docs], [self.doc1.id, self.doc7.id])
        ...
        with self.subTest("documents_for-general-staff"):
            ...
            self.assertEqual([d["id"] for d in docs], [self.doc1.id, self.doc6.id, self.doc8.id])
        ...
        with self.subTest("documents_for-bookmarks-user1"):
            ...
            self.assertEqual([d["id"] for d in docs], [self.doc1.id, self.doc2.id, self.doc7.id])
        ...
        with self.subTest("documents_for-bookmarks-staff"):
            ...
            self.assertEqual(
                [d["id"] for d in docs], [self.doc1.id, self.doc2.id, self.doc6.id, self.doc8.id]
            )
        ...
        with self.subTest("documents_for-sync-user1"):
            ...
            self.assertEqual([d["id"] for d in docs], [self.doc2.id, self.doc7.id])
        ...
        with self.subTest("documents_for-sync-staff"):
            ...
            self.assertEqual([d["id"] for d in docs], [self.doc2.id, self.doc6.id, self.doc8.id])
        ...
        with self.subTest("documents_for-general_sync-user1"):
            ...
            self.assertEqual([d["id"] for d in docs], [self.doc7.id])
        ...
        with self.subTest("documents_for-general_sync-staff"):
            ...
            self.assertEqual([d["id"] for d in docs], [self.doc6.id, self.doc8.id])
    ...
    def test_documents_for_fallback(self):
        ...
        with self.subTest("documents_for_fallback-staff"):
            ...
            self.assertEqual([d["id"] for d in fallbacks], [self.doc6.id])
