...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Delete all short links so they get regenerated."""
        num = orm.Document.objects.exclude(share_link='').update(share_link='')
        print '{num} short links deleted.'.format(num=num)
