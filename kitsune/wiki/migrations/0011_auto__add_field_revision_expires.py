...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.expires'
        db.add_column(u'wiki_revision', 'expires',
    ...
    models = {
        ...
        u'wiki.revision': {
            ...
            'difference': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
