...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'wiki_documentlink', ['linked_from_id', 'linked_to_id'])

        # Adding model 'DocumentImage'
        db.create_table(u'wiki_documentimage', (
        ...
        db.send_create_signal(u'wiki', ['DocumentImage'])

        # Adding unique constraint on 'DocumentImage', fields ['document', 'image']
        db.create_unique(u'wiki_documentimage', ['document_id', 'image_id'])

        # Adding unique constraint on 'DocumentLink', fields ['linked_from', 'linked_to', 'kind']
        db.create_unique(u'wiki_documentlink', ['linked_from_id', 'linked_to_id', 'kind'])


    def backwards(self, orm):
        # Removing unique constraint on 'DocumentLink', fields ['linked_from', 'linked_to', 'kind']
        db.delete_unique(u'wiki_documentlink', ['linked_from_id', 'linked_to_id', 'kind'])

        # Removing unique constraint on 'DocumentImage', fields ['document', 'image']
        db.delete_unique(u'wiki_documentimage', ['document_id', 'image_id'])

        # Deleting model 'DocumentImage'
        db.delete_table(u'wiki_documentimage')

        # Adding unique constraint on 'DocumentLink', fields ['linked_from', 'linked_to']
        db.create_unique(u'wiki_documentlink', ['linked_from_id', 'linked_to_id'])
