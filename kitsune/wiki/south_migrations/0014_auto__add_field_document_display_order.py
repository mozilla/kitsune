...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.display_order'
        db.add_column(u'wiki_document', 'display_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.display_order'
        db.delete_column(u'wiki_document', 'display_order')
    ...
    models = {
        ...
        u'wiki.document': {
            'Meta': {'ordering': "['display_order', 'id']", 'unique_together': "(('parent', 'locale'), ('title', 'locale'), ('slug', 'locale'))", 'object_name': 'Document'},
