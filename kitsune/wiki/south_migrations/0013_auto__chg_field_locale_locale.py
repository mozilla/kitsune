...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Locale.locale'
        db.alter_column(u'wiki_locale', 'locale', self.gf('kitsune.sumo.models.LocaleField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'Locale.locale'
        db.alter_column(u'wiki_locale', 'locale', self.gf('django.db.models.fields.CharField')(max_length=7))
