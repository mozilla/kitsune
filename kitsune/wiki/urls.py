...
document_patterns = [
    ...
    url(
        r"^/edit/(?P<revision_id>\d+)$",
        views.edit_document,
        name="wiki.new_revision_based_on",
    ),
    url(
        r"^/review/(?P<revision_id>\d+)$",
        views.review_revision,
    ...
    url(
        r"^/show_translations$", views.show_translations, name="wiki.show_translations"
    ),
...
urlpatterns = [
    url(
        r"^$",
        redirect_to,
        {"url": "products.product", "slug": "firefox"},
        name="wiki.landing",
    ),
...
urlpatterns += [
    ...
    url(
        r"^/all/discussions$",
        kbforums_views.locale_discussions,
        name="wiki.locale_discussions",
    ),
    url(
        r"^/discuss/watch_locale$",
        kbforums_views.watch_locale,
