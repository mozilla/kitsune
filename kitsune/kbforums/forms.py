...
MSG_TITLE_SHORT = _lazy(
    "Your title is too short (%(show_value)s "
    "characters). It must be at least %(limit_value)s "
    "characters."
)
MSG_TITLE_LONG = _lazy(
    "Please keep the length of your title to "
...
MSG_CONTENT_SHORT = _lazy(
    "Your message is too short (%(show_value)s "
    "characters). It must be at least %(limit_value)s "
    "characters."
)
MSG_CONTENT_LONG = _lazy(
    "Please keep the length of your message to "
    "%(limit_value)s characters or less. It is "
    "currently %(show_value)s characters."
)
