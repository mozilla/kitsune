...
class NotificationsTests(ForumTestCase):
    ...
    def test_watch_forum_then_new_thread(self, get_current):
        ...
        attrs_eq(
            mail.outbox[0], to=[watcher.email], subject=u"{f} - {t}".format(f=f, t=t)
        )
    ...
    def test_autowatch_new_thread(self, get_current):
        ...
        s = Setting.objects.create(
            user=u, name="forums_watch_new_thread", value="False"
        )
    ...
    def test_autowatch_reply(self, get_current):
        ...
        s = Setting.objects.create(
            user=u, name="forums_watch_after_reply", value="True"
        )
