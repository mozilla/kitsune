...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field questions_locales_enabled on 'Product'
        m2m_table_name = db.shorten_name(u'products_product_questions_locales_enabled')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'products.product'], null=False)),
            ('locale', models.ForeignKey(orm[u'wiki.locale'], null=False))
        ))
        db.create_unique(m2m_table_name, ['product_id', 'locale_id'])


    def backwards(self, orm):
        # Removing M2M table for field questions_locales_enabled on 'Product'
        db.delete_table(db.shorten_name(u'products_product_questions_locales_enabled'))
