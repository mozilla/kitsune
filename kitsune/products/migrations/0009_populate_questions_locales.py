...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        locales = orm['questions.QuestionLocale'].objects.all()
    ...
    models = {
        ...
        u'products.product': {
            ...
            'questions_locales': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['questions.QuestionLocale']", 'symmetrical': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
    ...
    complete_apps = ['questions', 'products']
    symmetrical = True
