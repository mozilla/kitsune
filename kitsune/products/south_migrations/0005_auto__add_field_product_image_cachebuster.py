...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.image_cachebuster'
        db.add_column(u'products_product', 'image_cachebuster',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.image_cachebuster'
        db.delete_column(u'products_product', 'image_cachebuster')
