...
class GoogleAnalyticsTests(TestCase):
    ...
    def test_visitors(self, _build_request):
        ...
        visits = googleanalytics.visitors(date(2013, 01, 16), date(2013, 01, 16))
    ...
    def test_pageviews_by_document(self, _build_request):
        ...
        for i in range(1, 6):
            documents.append(
                ApprovedRevisionFactory(document__slug="doc-%s" % i).document
            )
...
VISITORS_RESPONSE = {
    ...
    u"itemsPerPage": 1000,
    u"totalsForAllResults": {u"ga:visitors": u"382719"},
    u"columnHeaders": [
...
VISITORS_BY_LOCALE_RESPONSE = {
    ...
    u"itemsPerPage": 1000,
    u"totalsForAllResults": {u"ga:visitors": u"437598"},
    u"columnHeaders": [
        {
            u"dataType": u"STRING",
...
PAGEVIEWS_BY_DOCUMENT_RESPONSE = {
    ...
    u"itemsPerPage": 10,
    u"totalsForAllResults": {u"ga:pageviews": u"164293"},
    u"nextLink": (
        "https://www.googleapis.com/analytics/v3/data/ga"
...
PAGEVIEWS_BY_QUESTION_RESPONSE = {
    u"columnHeaders": [
        {u"columnType": u"DIMENSION", u"dataType": u"STRING", u"name": u"ga:pagePath"},
    ...
    u"rows": [
        ...
        [u"/es/questions/3?lang=en-US", u"1"],
    ],  # Counts as a pageview.
    u"selfLink": (
        "https://www.googleapis.com/analytics/v3/data/ga"
        "?ids=ga:65912487&dimensions=ga:pagePath"
...
SEARCH_CTR_RESPONSE = {
    ...
    u"itemsPerPage": 1000,
    u"totalsForAllResults": {u"ga:goal11ConversionRate": u"74.88925980111263"},
    u"columnHeaders": [
        {
