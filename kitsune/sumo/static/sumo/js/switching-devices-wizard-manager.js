...
export default class SwitchingDevicesWizardManager {
  ...
  steps = Object.freeze([
    {
      ...
      enter(state) {
        trackEvent("dmw_report_state", {dmw_state: "sign-into-fxa"});
        let baseParams = {
    ...
    },
    {
      ...
      enter(state) {
        trackEvent("dmw_report_state", {dmw_state: "configure-sync"});
        return {
    ...
    },
    {
      ...
      enter(state) {
        trackEvent("dmw_report_state", {dmw_state: "setup-new-device"});
        return {};
      },
    },
  ]);
  ...
  async #init(
    ...
    try {
      ...
      if (browser.mozilla && !platform.mobile) {
        ...
        try {
          ...
          trackEvent("dmw_report_state", {dmw_state: "uitour-broken"});
    ...
    trackEvent("dmw_report_state", {dmw_state: "need-fx-desktop"});
