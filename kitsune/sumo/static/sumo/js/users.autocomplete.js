...
(function ($) {
  ...
  function init() {
    ...
    var tokenInputSettings = {
      ...
      resultsFormatter: function (item) {
        ...
        if (item.display_name) {
          return k.safeInterpolate(
            '<li><img src="%(avatar)s"/><div class="name_search">%(display_name)s [%(username)s]</div></li>',
            item,
            true
          );
        }
        return k.safeInterpolate(
          '<li><img src="%(avatar)s"/><div class="name_search">%(username)s</div></li>',
          item,
          true
        );
      },
    ...
    $("input.user-autocomplete").tokenInput(
