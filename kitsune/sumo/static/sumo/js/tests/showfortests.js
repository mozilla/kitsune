...
describe("ShowFor", () => {
        ...
        <div className="product" data-product="firefox">
          ...
          <div className="selectbox-wrapper">
            <select className="version" value="version:fx24">
              <option value="version:fx26" data-min="26.0" data-max="27.0">
                Version 26
              </option>
              <option value="version:fx25" data-min="25.0" data-max="26.0">
                Version 25
              </option>
              <option value="version:fx24" data-min="24.0" data-max="25.0">
                Version 24
              </option>
              <option value="version:fx23" data-min="23.0" data-max="24.0">
                Version 23
              </option>
              <option value="version:fx17" data-min="17.0" data-max="18.0">
                Version 17 (ESR)
              </option>
            </select>
          </div>
        ...
        <div className="product" data-product="mobile">
          ...
          <div className="selectbox-wrapper">
            <select className="version" value="version:m24">
              <option value="version:m26" data-min="26.0" data-max="27.0">
                Version 26
              </option>
              <option value="version:m25" data-min="25.0" data-max="26.0">
                Version 25
              </option>
              <option value="version:m24" data-min="24.0" data-max="25.0">
                Version 24
              </option>
              <option value="version:m23" data-min="23.0" data-max="24.0">
                Version 23
              </option>
            </select>
          </div>
              ...
              products: [
                {
                  slug: "firefox",
                  title: "Firefox",
                  platforms: ["linux", "mac", "winxp", "win7", "win8"],
                },
                {
                  slug: "mobile",
  ...
  describe("loadData", () => {
    ...
    it("should pull the denormalized forms out of the data", () => {
      unorderedEquals(showFor.productSlugs, [
        "firefox",
        "mobile",
        "firefox-os",
      ]);
      unorderedEquals(showFor.platformSlugs, [
        "web",
        "android",
        "linux",
        "mac",
  ...
  describe("updateUI", () => {
    describe("Firefox 26 on Windows XP", () => {
      ...
      it("should populate the UI with the values from BrowserDetect", () => {
        expect(
          $(".product[data-product=firefox] select.version").val()
        ).to.equal("version:fx26");
        expect(
          $(".product[data-product=firefox] select.platform").val()
        ).to.equal("platform:winxp");
      });
    });
    ...
    describe("Firefox for Android 23", () => {
      ...
      it("should populate the UI with the values from BrowserDetect", () => {
        expect(
          $(".product[data-product=mobile] select.version").val()
        ).to.equal("version:m23");
        expect(
          $(".product[data-product=mobile] select.platform")
        ).to.have.length(0);
      });
    });
  });
