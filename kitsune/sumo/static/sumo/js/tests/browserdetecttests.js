...
describe("BrowserDetect", () => {
  ...
  describe("Fennec versions", () => {
    it("should detect Fennec 7", () => {
      let ua =
        "Mozilla/5.0 (Android; Linux armv7l; rv:7.0.1) Gecko/ Firefox/7.0.1 Fennec/7.0.1";
      expect(
        BrowserDetect.searchString(BrowserDetect.dataBrowser, ua)
      ).to.equal("m");
  ...
  describe("Windows versions", () => {
    let cases = [
      {
        ua:
          "Mozilla/5.0 (Windows NT 5.0; WOW64; rv:12.0) Gecko/20100101 Firefox/12.0",
        expected: ["fx", 12, "winxp"],
      },
      {
        ua:
          "Mozilla/5.0 (Windows NT 5.01; WOW64; rv:12.0) Gecko/20100101 Firefox/13.0",
        expected: ["fx", 13, "winxp"],
      },
      {
        ua:
          "Mozilla/5.0 (Windows NT 5.1; WOW64; rv:12.0) Gecko/20100101 Firefox/14.0",
        expected: ["fx", 14, "winxp"],
      },
      {
        ua:
          "Mozilla/5.0 (Windows NT 6.0; WOW64; rv:12.0) Gecko/20100101 Firefox/15.0",
        expected: ["fx", 15, "win7"],
      },
      {
        ua:
          "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:12.0) Gecko/20100101 Firefox/16.0",
        expected: ["fx", 16, "win7"],
      },
      {
        ua:
          "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:12.0) Gecko/20100101 Firefox/17.0",
        expected: ["fx", 17, "win8"],
      },
      {
        ua:
          "Mozilla/5.0 (Windows NT 4.0; WOW64; rv:12.0) Gecko/20100101 Firefox/4.0",
        expected: ["fx", 4, "win"],
      },
    ];
    ...
    for (let case_ of cases) {
      it(`should detect ${case_.expected}`, () => {
        expect(
          BrowserDetect.searchString(BrowserDetect.dataOS, case_.ua)
        ).to.equal(case_.expected[2]);
  ...
  describe("Firefox for iOS", () => {
    ...
    let cases = [
      {
        ua:
          "Mozilla/5.0 (iPhone; CPU iPhone OS 8_2 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/1.0.0 Mobile/12D508 Safari/600.1.4",
        version: 1.0,
      },
      {
        ua:
          "Mozilla/5.0 (iPhone; CPU iPhone OS 8_2 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/1.0.1 Mobile/12D508 Safari/600.1.4",
        version: 1.0,
      },
      {
        ua:
          "Mozilla/5.0 (iPhone; CPU iPhone OS 8_2 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/1.1.0 Mobile/12D508 Safari/600.1.4",
        version: 1.1,
      },
    ];
