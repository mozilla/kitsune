...
pgettext(
    "DB: products.Topic.description", """Control the information that Firefox saves"""
)
pgettext(
    "DB: products.Topic.title",
...
pgettext(
    "DB: products.Topic.description", """Firefox options, preferences and settings"""
)
...
pgettext(
    "DB: products.Topic.title", """Error messages: what they mean and how to fix"""
)
pgettext(
    "DB: products.Topic.description",
...
pgettext(
    "DB: products.Topic.title", """Unblock Firefox from connecting to the Internet"""
)
pgettext(
    "DB: products.Topic.description",
...
pgettext(
    "DB: products.Topic.description", """Procedures to diagnose and fix problems"""
)
pgettext(
    "DB: products.Topic.title", """Videos, sound, pictures and animations don't work"""
)
pgettext(
    "DB: products.Topic.description",
...
pgettext(
    "DB: products.Topic.description", """Deploying Firefox on Windows computers."""
)
...
pgettext(
    "DB: products.Topic.description", """How to configure Firefox for Enterprise"""
)
...
pgettext(
    "DB: products.Topic.description", """Change Firefox's settings using policies."""
)
pgettext("DB: products.Topic.title", """Manage add-ons""")
pgettext(
    "DB: products.Topic.description",
...
pgettext(
    "DB: products.Topic.description", """Surf and navigate the Web on Firefox Preview"""
)
...
pgettext(
    "DB: products.Topic.description", """Protect your privacy on Firefox Preview."""
)
...
pgettext(
    "DB: products.Topic.description", """Troubleshoot issues with Firefox Preview"""
)
...
pgettext(
    "DB: products.Topic.description", """Learn how to view content on another screen"""
)
...
pgettext(
    "DB: products.Topic.description", """Troubleshoot problems with Firefox for iOS."""
)
...
pgettext(
    "DB: products.Topic.description", """Customize preferences for Firefox for iOS"""
)
...
pgettext("DB: products.Topic.title", """Get started""")
pgettext(
    "DB: products.Topic.description", """Basics for using Firefox Private Network."""
)
pgettext("DB: products.Topic.title", """Fix problems""")
pgettext(
    "DB: products.Topic.description", """Troubleshoot problems with Firefox Fire TV"""
)
...
pgettext("DB: products.Topic.title", """Fix problems""")
pgettext(
    "DB: products.Topic.description", """Troubleshoot issues for Private Network"""
)
...
pgettext(
    "DB: products.Topic.description", """Get help with the Webmaker app for Android."""
)
...
pgettext(
    "DB: products.Topic.description", """Learn how to create, assess and issue badges"""
)
pgettext("DB: products.Topic.title", """Accounts""")
pgettext(
    "DB: products.Topic.description", """Find solutions on managing your account"""
)
...
pgettext(
    "DB: products.Topic.description", """Help or get help on a Webmaker project."""
)
...
pgettext("DB: products.Topic.title", """Fix problems""")
pgettext(
    "DB: products.Topic.description", """Troubleshoot issues with Firefox Lockwise"""
)
...
pgettext(
    "DB: products.Topic.description", """Information for Developers and Beta users."""
)
...
pgettext("DB: products.Topic.title", """Fix problems""")
pgettext(
    "DB: products.Topic.description", """Troubleshoot problems with Firefox Lite."""
)
...
pgettext(
    "DB: products.Topic.description", """Learn how to manage your email messages"""
)
...
pgettext(
    "DB: products.Topic.description", """How to use the address book on Thunderbird"""
)
pgettext("DB: products.Topic.title", """Calendar""")
pgettext(
    "DB: products.Topic.description", """Related to the Lightning add-on for Calendar"""
)
pgettext("DB: products.Topic.title", """Customize controls, options and add-ons""")
pgettext(
    "DB: products.Topic.description", """Customize controls, options and add-ons"""
)
...
pgettext(
    "DB: products.Topic.title", """Thunderbird options, preferences and settings """
)
pgettext(
    "DB: products.Topic.description",
...
pgettext(
    "DB: products.Topic.description", """Troubleshoot error messages on Thunderbird."""
)
...
pgettext(
    "DB: products.Product.description", """Web browser for Windows, Mac and Linux"""
)
...
pgettext(
    "DB: products.Product.title", """Firefox Private Network Browser-level protection"""
)
pgettext("DB: products.Product.description", """Browse securely on public Wi-Fi""")
pgettext(
    "DB: products.Product.title", """Firefox Private Network Device-level Protection"""
)
pgettext(
    "DB: products.Product.description", """VPN for Windows 10 and Android devices"""
)
...
pgettext(
    "DB: products.Product.description", """Web browser for virtual reality headsets"""
)
...
pgettext(
    "DB: products.Product.description", """Email software for Windows, Mac and Linux"""
)
