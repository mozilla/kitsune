...
pgettext("DB: products.Product.description", """Virtual 3D meeting spaces for collaborating with friends, family, and colleagues on your browser or VR headset""")
...
pgettext("DB: products.Topic.title", """Subscriptions and Payments""")
...
pgettext("DB: products.Topic.title", """Firefox Accounts and Login""")
...
pgettext("DB: products.Topic.title", """Support articles""")
...
pgettext("DB: products.Topic.title", """Mobile Support""")
pgettext("DB: products.Topic.description", """Topic for any KB articles related to the Mobile Support contribution""")
