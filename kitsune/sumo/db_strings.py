...
pgettext("DB: products.Product.title", """Monitor Data Removal Pilot""")
...
pgettext("DB: products.Topic.title", """Play Store Support""")
pgettext("DB: products.Topic.description", """Topic for any KB articles related to the Play Store Support contribution""")
