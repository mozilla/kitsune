...
DMS_HANDLE_DUE_TASKS_FOR_TRANSLATIONS = config(
    "DMS_HANDLE_DUE_TASKS_FOR_TRANSLATIONS", default=None
)
...
AI_REVIEW_GRACE_PERIOD = config("AI_REVIEW_GRACE_PERIOD", default=3, cast=int)
