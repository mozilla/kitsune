...
RETRIEVAL_SEARCH_SEGMENT_SIZE = config("RETRIEVAL_SEARCH_SEGMENT_SIZE", default=50, cast=int)
RETRIEVAL_SEARCH_SESSION_TTL_SECONDS = config(
    "RETRIEVAL_SEARCH_SESSION_TTL_SECONDS", default=10 * 60, cast=int
)
