...
from kitsune.gallery import forms, views
...
TEST_VID = {'webm': 'kitsune/gallery/tests/media/test.webm',
            'ogv': 'kitsune/gallery/tests/media/test.ogv',
            'thumbnail': TEST_IMG,
            'flv': 'kitsune/gallery/tests/media/test.flv'}
INVALID_VID = 'kitsune/gallery/tests/media/test.rtf'
...
class UploadImageTests(TestCase):
    ...
    def test_invalid_image(self):
        ...
        with open('kitsune/gallery/__init__.py', 'rb') as f:
            r = post(self.client, 'gallery.upload_async', {'file': f},
                     args=['image'])
