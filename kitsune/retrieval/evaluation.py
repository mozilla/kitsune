...
def build_golden_set(*, locales=(), limit: int | None = None, generation: str = "") -> GoldenSet:
    ...
    # Imported here rather than at module scope: questions imports wiki, and wiki's signals
    # import retrieval, so a top-level import closes that cycle at startup.
