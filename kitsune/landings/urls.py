...
urlpatterns = [
    ...
    url(r'^download-firefox-integrity-check$', views.integrity_check,
        name='download.integrity-check'),

    url(r'^get-involved/questions$', views.get_involved_questions,
        name='landings.get_involved_questions'),
    url(r'^get-involved/kb$', views.get_involved_kb,
        name='landings.get_involved_kb'),
    url(r'^get-involved/l10n$', views.get_involved_l10n,
